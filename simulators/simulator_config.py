...
def create_custom_device_config(name: str, device_type: str, location: str, 
                               telemetry_interval: int = None, 
                               heartbeat_interval: int = None) -> Dict[str, Any]:
    ...
    return {
        ...
        'location': location,
        'telemetry_interval': telemetry_interval or type_config.default_telemetry_interval,
        'heartbeat_interval': heartbeat_interval or type_config.default_heartbeat_interval
    }
...
if __name__ == "__main__":
    ...
    for device_type, config in DEVICE_TYPES.items():
        ...
        print(f"  Default intervals: Telemetry={config.default_telemetry_interval}s, Heartbeat={config.default_heartbeat_interval}s")
        print("  Sensors:")
        for sensor_name, sensor_config in config.sensors.items():
            print(f"    - {sensor_name}: {sensor_config.min_value}-{sensor_config.max_value} {sensor_config.unit}")
