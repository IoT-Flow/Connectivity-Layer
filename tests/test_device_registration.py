...
class TestDeviceRegistration(unittest.TestCase):
    ...
    def test_duplicate_device_name(self):
        ...
        # First registration
        first_payload = {"name": device_name, "device_type": "sensor", "user_id": self.test_user_id}

        self.client.post("/api/v1/devices/register", data=json.dumps(first_payload), content_type="application/json")

        # Try to register again with same name
        second_payload = {"name": device_name, "device_type": "actuator", "user_id": self.test_user_id}

        response = self.client.post(
            "/api/v1/devices/register", data=json.dumps(second_payload), content_type="application/json"
        )
    ...
    def test_missing_required_fields(self):
        ...
        # Missing name
        payload = {"device_type": "sensor", "user_id": self.test_user_id}
        ...
        # Missing device_type
        payload = {"name": f"Missing_Type_Device_{int(time.time())}", "user_id": self.test_user_id}
        ...
        # Missing user_id
        payload = {"name": f"Missing_User_Device_{int(time.time())}", "device_type": "sensor"}
    ...
    def test_multiple_devices_per_user(self):
        ...
        first_payload = {"name": first_device_name, "device_type": "sensor", "user_id": self.test_user_id}

        first_response = self.client.post(
            "/api/v1/devices/register", data=json.dumps(first_payload), content_type="application/json"
        )
        ...
        second_payload = {"name": second_device_name, "device_type": "actuator", "user_id": self.test_user_id}
