    ...
    def test_device_registration(self):
        ...
        try:
            ...
            payload = {
                ...
                "user_id" : "170216b4fa0e4c1cb143a77bd1acb516"
            }
    ...
    def test_iotdb_verification(self):
        ...
        try:
            ...
            if response.status_code not in [200, 201]:
                self.log_test("IoTDB Verification", False, f"Failed to send verification telemetry: {response.status_code}")
                return False
            ...
            if stored_in_iotdb:
                self.log_test("IoTDB Verification", True, 
                            f"Telemetry successfully stored in IoTDB for device {self.test_device_id}")
                return True
            else:
                self.log_test("IoTDB Verification", False, 
                            "Telemetry was not stored in IoTDB")
                return False
